...
if (! ZEND_INSTALL_DIR) {
	terminateScript("could not determine the Zend Install Directory - probably as a result of the fact that the user running the script does not have permissions to read zend ini files");
}
