 ...
 */
$classes .= ' page--'.strtolower(str_replace('/', '--', preg_replace('/'.str_replace('/', '\/', preg_quote(base_path())).'(.*)$/s', '$1', drupal_get_path_alias(request_uri(), 1), 1)));
if (arg(2) == 'edit')
{
	$classes .= ' edit-page create-edit-page';
}
if (arg(1) == 'add')
{
