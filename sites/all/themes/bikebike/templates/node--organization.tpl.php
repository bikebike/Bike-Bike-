...
<?php print render($title_prefix); ?>
  ...
  <?php print render($title_suffix); ?>
	...
	<?php /*<div id="node-<?php print $node->nid ?>" class="node node-<?php print $node->type ?>">

	<?php print theme('image_style', array('style_name' => 'icon_meduim', 'path' => $node->field_logo[$node->language][0]['uri'], 'attributes' => array('class' => 'logo'))); ?>
	<h3 class="teaser-title"><?php print $title ?></h3>
  <div<?php print $content_attributes; ?>>
    <?php print render($content); ?>
  </div>
